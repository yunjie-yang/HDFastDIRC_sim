		...
		int save_kin /* = -1*/)
{
		...
		std::cout<<"particle_bar      = "<<particle_bar<<std::endl;
		std::cout<<"particle_x        = "<<particle_x<<std::endl;
		std::cout<<"particle_y        = "<<particle_y<<std::endl;
		std::cout<<"particle_t        = "<<particle_t<<std::endl;
		std::cout<<"particle_theta    = "<<particle_theta<<std::endl;
		std::cout<<"particle_phi      = "<<particle_phi<<std::endl;
		std::cout<<"phi_theta_unc     = "<<phi_theta_unc<<std::endl;
